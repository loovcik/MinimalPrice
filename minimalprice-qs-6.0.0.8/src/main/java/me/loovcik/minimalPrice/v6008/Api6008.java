package me.loovcik.minimalPrice.v6008;

import com.ghostchu.quickshop.api.shop.Shop;
import me.loovcik.minimalPrice.api.quickshop.Api;
import me.loovcik.minimalPrice.v6008.listeners.*;
...
public class Api6008 extends Api {
	...
	public void registerListeners() {
		if (isDebug())
			ChatHelper.console("Registering [<red>Legacy</red>] QuickShop listeners...");
		...
		if (isDebug())
			ChatHelper.console("QuickShop [<red>Legacy</red>] listeners <green>registered</green>");
	}
